	...
	methods: {
		...
		reload: function (event) {
			...
			$("#jqGrid").jqGrid('setGridParam',{ 
                page:page,
                postData:{'pId': vm.q.parentId},
            }).trigger("reloadGrid");
		},
		queryParenMenuList:function(parentId){ 
			$.get("../sys/menu/list?page=1&limit=100&parentId="+parentId, function(r){
				console.log(r);
				vm.parenMenuList =[];
				vm.parenMenuList = r.page.list; 
			})
		}
